...
function render(counters) {
  ...
  for(let counter of counters){
    ...
    <tr data-status="${data_status}">
      ...
      <td>
        <a href="/Jamigo/counter/counter_ctrl/counter_accountEdit.html?counterNo=${counter.counterNo}" class="btn btn-edit">
...
document.querySelector('.panel-table').addEventListener('click', e => {
  if(e.target.matches('.btn-info')) {
    ...
    `;
    document.querySelector('.modal-footer a').href = `/Jamigo/counter/counter_ctrl/counter_accountEdit.html?counterNo=${counter.counterNo}`;
